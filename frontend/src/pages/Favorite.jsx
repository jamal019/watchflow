  ...
  return (
    <>
      <div className="favoritesPage">
        <h1>Favorites</h1>
        <br />
        <button className="shareBtn" onClick={() => shareOnWhatsApp(favorites)}>
          Share
        </button>
        <div className="favoritesWrap">
          {favorites.length === 0 ? (
            <p style={{margin: "0 auto",textAlign:"center"}} className="noFavorites">No favorites yet. <br/> Swipe to add your favorite movies.</p>
          ) : (
            favorites.map((fav) => (
